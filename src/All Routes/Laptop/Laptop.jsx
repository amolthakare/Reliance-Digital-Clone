    ...
    useEffect(() => {
        const getComments = async () => {
          const res = await fetch(
            `http://localhost:8080/laptop?_page=1&_limit=${limit}`
          );
      ...
      const fetchComments = async (currentPage) => {
        const res = await fetch(
          `http://localhost:8080/laptop?_page=${currentPage}&_limit=${limit}`
        );
        const data = await res.json();
        return data;
      };
        ...
        <div className={styles.main}>
            ...
            <div className={styles.left}>
                ...
                <div className={styles.pp}>
                    <p className={styles.qq}>₹32999</p>
                    <p>to</p>
                    <p className={styles.qq}>₹59999</p>
                ...
                <input type="checkbox" id="cat"/>
                <label for="cat">HP</label>
                <br/>
                <input type="checkbox" id="cat"/>
                <label for="cat">Lenovo</label>
                <br/>
                <input type="checkbox" id="cat"/>
                    <label for="cat">Dell</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Apple</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Acer</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Asus</label>
                    <br/>
