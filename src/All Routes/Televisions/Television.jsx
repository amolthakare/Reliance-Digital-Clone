    ...
    useEffect(() => {
        const getComments = async () => {
          const res = await fetch(
            `http://localhost:8080/television?_page=1&_limit=${limit}`
          );
      ...
      const fetchComments = async (currentPage) => {
        const res = await fetch(
          `http://localhost:8080/television?_page=${currentPage}&_limit=${limit}`
        );
        const data = await res.json();
        return data;
      };
        ...
        <div className={styles.main}>
            ...
            <div className={styles.left}>
                ...
                <input type="checkbox" id="cat"/>
                    ...
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Kodak</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Mi</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">LG</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">TCL</label>
