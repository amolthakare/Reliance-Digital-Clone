    ...
    useEffect(() => {
        const getComments = async () => {
          const res = await fetch(
            `http://localhost:8080/earphone?_page=1&_limit=${limit}`
          );
      ...
      const fetchComments = async (currentPage) => {
        const res = await fetch(
          `http://localhost:8080/earphone?_page=${currentPage}&_limit=${limit}`
        );
        const data = await res.json();
        return data;
      };
    ...
    return (
        ...
        <div className={styles.main}>
            ...
            <div className={styles.left}>
                ...
                <br/>
                <input type="checkbox" id="cat"/>
                <label for="cat">Sony</label>
                <br/>
                <input type="checkbox" id="cat"/>
                    <label for="cat">Samsung</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">JBL</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Mi</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Boat</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">SkullCandy</label>
