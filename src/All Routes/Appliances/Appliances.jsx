...
import {
    ...
    SliderTrack,
    // SliderFi00lledTrack,
    SliderThumb,SliderFilledTrack,Button,
    ...
    useEffect(() => {
        const getComments = async () => {
          const res = await fetch(
            `http://localhost:8080/appliances?_page=1&_limit=${limit}`
          );
      ...
      const fetchComments = async (currentPage) => {
        const res = await fetch(
          `http://localhost:8080/appliances?_page=${currentPage}&_limit=${limit}`
        );
        const data = await res.json();
        return data;
      };
    ...
    return (
        ...
        <div className={styles.main}>
            ...
            <div className={styles.left}>
                ...
                <input type="checkbox" id="cat"/>
                <label for="cat">Pigeon</label>
                <br/>
                <input type="checkbox" id="cat"/>
                <label for="cat">Reconnect</label>
                <br/>
                <input type="checkbox" id="cat"/>
                    <label for="cat">LifeLong</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">BPL</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Misfit</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Prestige</label>
                    <br/>
                    <input type="checkbox" id="cat"/>
                    <label for="cat">Candes</label>
